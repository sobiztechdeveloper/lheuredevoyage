            ...
            <div class="search-box cruise-search">
                <div class="search-form">
                    <form method="GET" action="{{ route('cruise') }}">
                        <x-catalog-search-preserved-inputs :except="['destination', 'q', 'page', 'adult', 'children', 'infant', 'departure_month', 'cruise_line', 'sort', 'min_price', 'max_price', 'region', 'duration', 'cabin_type', 'featured_only', 'categories', 'facilities']" />
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-xl-9">
                <div class="booking-sort mb-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
                    ...
                    <form method="GET" action="{{ route('cruise') }}" class="booking-sort-box" style="min-width:220px;">
