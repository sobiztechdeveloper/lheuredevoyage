...
<!-- breadcrumb -->
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/08.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Cruise Booking</h2>
        ...
        <!-- cruise booking -->
        <div class="cruise-booking py-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="booking-summary">
                            ...
                            <div class="booking-property-content">
                                <div class="booking-property-title">
                                    <div>
                                        <h5>Night Cruise To The Mediterranean</h5>
                            ...
                            <div class="booking-info-summary">
                                <h5>Order Info</h5>
                                <ul>
                                    <li>Journey Date: <span>20 Aug 2025 at 10:10 AM</span></li>
                                    <li>Return Date: <span>25 Aug 2025 at 10:10 AM</span></li>
                                    <li>Duration: <span>7 Days</span></li>
                                    <li>Cruise: <span>MSC Cruise</span></li>
                                    <li>Cruise Class: <span>In Cabin</span></li>
                                    <li>Extra Benefits: <span>No</span></li>
                                    <li>Food & Dining: <span>$220.00</span></li>
