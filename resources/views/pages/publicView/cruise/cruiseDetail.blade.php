...
<!-- breadcrumb -->
        <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/08.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Cruise Single</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Cruise Single</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
        ...
        <!-- cruise-single -->
        <div class="cruise-single py-120">
            <div class="container">
                        ...
                        <div class="col-lg-8">
                            <div class="listing-content">
                                <div class="listing-slider owl-carousel owl-theme">
                                    <img src="assets/img/cruise/single-1.jpg" alt="">
                                    <img src="assets/img/cruise/single-2.jpg" alt="">
                                    <img src="assets/img/cruise/single-3.jpg" alt="">
                                </div>
                                <div class="listing-header">
                                    <div class="listing-header-info">
                                        <h4 class="listing-title">10 Night Cruise To The Mediterranean</h4>
                                ...
                                <div class="listing-item">
                                    ...
                                    <div class="listing-info">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <ul class="list">
                                                    <li><span>Date Launched:</span> 2010</li>
                                                    <li><span>Total Staff:</span> 1,250 Crew</li>
                                                    <li><span>Tonnage:</span> 70,600 grt</li>
                                                    <li><span>Dining Crew:</span> 150 Crew</li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-6">
                                                <ul class="list">
                                                    <li><span>Length:</span> 840 ft</li>
                                                    <li><span>Beam:</span> 115 ft</li>
                                                    <li><span>Draft:</span> 35 ft</li>
                                                    <li><span>Speed:</span> 25.6 knots</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing-item">
                                    <h4 class="mb-3">Cruise Amenities</h4>
                                    <div class="listing-amenity">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-bath"></i> Bathroom</h6>
                                                    <ul class="list">
                                                        <li>Towels</li>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-tv"></i> Media & Technology</h6>
                                                    <ul class="list">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-shield-cross"></i> Safety & Security</h6>
                                                    <ul class="list">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-bowl-hot"></i> Food & Drink</h6>
                                                    <ul class="list">
                                                        <li>Kid Meals</li>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-table-tennis-paddle-ball"></i> Sports and Fitness</h6>
                                                    <ul class="list">
                                                        <li>Aerobics</li>
                                                        <li>Basketball</li>
                                                        <li>Fitness Center Or Gym</li>
                                                        <li>Health Or Nutrition Evaluations</li>
                                                        <li>Jogging Track</li>
                                                        <li>Sports Court</li>
                                                        <li>Tennis</li>
                                                        <li>Yoga</li>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="listing-amenity-item">
                                                    <h6><i class="far fa-cog"></i> Other Facilities</h6>
                                                    <ul class="list">
                                                        <li>Concierge Desk</li>
                                                        <li>Laundry Service</li>
                                                        <li>Medical Center</li>
                                                        <li>Internet Center</li>
