...
<div class="site-breadcrumb" style="background: url({{ asset('assets/img/breadcrumb/01.jpg') }})">
    <div class="container">
        <h2 class="breadcrumb-title">Quote Request Received</h2>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="fbw-card text-center">
                    ...
                    <p class="text-muted mb-4">Your insurance quote request has been received. An agent will review your details and send a personalised quote — no payment is required at this stage.</p>
                    ...
                    <div class="d-flex flex-wrap gap-2 justify-content-center mt-4">
                        @auth
                            <a href="{{ route('my-insurance-requests.index') }}" class="fbw-btn-primary">My Insurance Requests</a>
                        @else
                            <a href="{{ route('login') }}" class="fbw-btn-primary">Sign in to track requests</a>
                        @endauth
