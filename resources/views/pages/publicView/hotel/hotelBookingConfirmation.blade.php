        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="fbw-card text-center">
                    <div class="mb-3">
                        <span class="d-inline-flex align-items-center justify-content-center rounded-circle text-white" style="width:72px;height:72px;font-size:2rem;background:#3361AC;"><i class="fas fa-check"></i></span>
                    </div>
                    <h3 class="mb-2" style="color:#162F65;">Thank You</h3>
                    <p class="text-muted mb-4">Your hotel booking request has been received.</p>
                    ...
                    <p class="text-muted">Our travel consultant will contact you shortly at <strong>{{ $booking->lead_guest_email }}</strong>.</p>
                    <div class="d-flex flex-wrap gap-2 justify-content-center mt-4">
                        @auth
                            <a href="{{ route('my-hotel-bookings.index') }}" class="fbw-btn-primary">My Hotel Bookings</a>
                        @else
