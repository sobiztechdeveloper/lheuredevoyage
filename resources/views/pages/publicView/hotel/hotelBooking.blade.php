...
<div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/05.jpg)">
    <div class="container">
        <h2 class="breadcrumb-title">Hotel Booking</h2>
                ...
                <div class="booking-summary">
                    ...
                    <div class="booking-property-content">
                        <div class="booking-property-title">
                            <div>
                                <h5>Western Grant Park Hotel</h5>
                    ...
                    <div class="booking-info-summary">
                        ...
                        <ul>
                            ...
                            <li>Room Type: <span>Superior Double</span></li>
                            <li>Room: <span>3 Rooms</span></li>
                            <li>Per Room Price: <span>$150</span></li>
                            <li>Extra Benefits: <span>No</span></li>
                            <li>Adults: <span>4</span></li>
                            <li>Childs: <span>2</span></li>
                            <li>Stay: <span>7 Nights</span></li>
                        </ul>
                    </div>
