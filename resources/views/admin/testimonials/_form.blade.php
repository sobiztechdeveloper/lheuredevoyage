<div class="row g-3">
    ...
    <div class="col-md-4"><label class="form-label">Photo</label>@if($testimonial->image)<img src="{{ $testimonial->image_url }}" height="60" class="d-block mb-2 rounded" alt="">@endif<input type="file" name="image" class="form-control" accept="image/*"></div>
